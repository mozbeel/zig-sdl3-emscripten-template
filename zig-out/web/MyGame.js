...
var wasmSourceMapFile = "MyGame.wasm.map";
...
var ASM_CONSTS = {
  ...
  179843: () => Module["SDL3"].audioContext.sampleRate,
  179894: ($0, $1, $2, $3) => {
    var SDL3 = Module["SDL3"];
  ...
  186017: () => (navigator.mediaDevices === undefined) ? 0 : 1,
  186076: ($0, $1, $2, $3, $4, $5, $6) => {
    const device = $0;
    const w = $1;
    const h = $2;
  ...
  197045: () => window.innerWidth,
  197075: () => window.innerHeight,
  197106: $0 => {
